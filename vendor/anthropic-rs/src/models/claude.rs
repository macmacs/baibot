...
pub enum ClaudeModel {
    #[serde(rename = "claude-3-7-sonnet-250219")]
    Claude37Sonnet250219,
...
impl ClaudeModel {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Claude37Sonnet250219 => "claude-3-7-sonnet-250219",
...
impl FromStr for ClaudeModel {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "claude-3-7-sonnet-250219" => Ok(Self::Claude37Sonnet250219),
...
mod tests {
    ...
    fn should_serialize_to_correct_model_names() {
        assert_eq!(
            ClaudeModel::Claude37Sonnet250219.as_str(),
            "claude-3-7-sonnet-250219",
        );
        assert_eq!(
    ...
    fn should_deserialize_to_correct_models() {
        assert_eq!(
            ClaudeModel::Claude37Sonnet250219,
            ClaudeModel::from_str("claude-3-7-sonnet-250219").unwrap(),
        );
        assert_eq!(
